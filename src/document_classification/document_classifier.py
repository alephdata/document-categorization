...
from preprocessing.convert_to_img import convert_all_to_jpg
from preprocessing.train_val_test_split import get_split_and_labels, compare_input_with_selected_labels
from preprocessing.import_data import import_images
...
class DocumentClassifier(ImageModel):
    ...
    def __init__(
        ...
        self.MLFLOW_FEATURE_EXTRACTOR_ID: str = settings.MLFLOW_FEATURE_EXTRACTOR_ID
    ...
    def load_trained_classifier_from_mlflow(self, run_id: str) -> None:
        ...
        labels_csv_path = os.path.join(
            (mlflow.get_run("cf37dad071c542ef8738ad9c8c1e24b6").info.artifact_uri.split("file://")[-1]), "labels.csv"
        )

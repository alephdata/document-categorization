...
os.makedirs(config.settings.DATA_PATH_LOGS, exist_ok=True)
...
LOGGING_FILENAME = datetime.datetime.now().strftime(os.path.join(config.settings.DATA_PATH_LOGS, r"%Y_%m_%d_%H_%M_%S.log"))

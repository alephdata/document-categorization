...
def convert_pdf_to_jpg(input_path_to_file: str, output_path: str, only_first_page: bool) -> None:
    ...
    Args:
        ...
        only_first_page (bool): if True, only saves and converts the first page of the document.
...
def copy_jpg_to_jpg(input_path_to_file: str, output_path: str) -> None:
    ...
    Args:
        ...
        only_first_page (bool): if True, only saves and converts the first page.
    """
...
def convert_all_to_jpg(
    ...
    Args:
        ...
        only_first_page (bool, optional): if True, only saves and converts the first page of each document. Defaults to False.

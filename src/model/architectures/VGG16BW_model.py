...
def create_model_VGG16BW(
    ...
    """
    Creates the VGG16BW model.

    Args:
        verbose (bool, optional): Verbose feedback, defaults to False.

    Returns
        Compiled VGG16 model with input layer of 224x224x1 and output layer with 16 nodes.
    """
    ...
    model = keras.models.Sequential(
        [
            # Block 1
            Conv2D(32, (3, 3), input_shape=(im_size, im_size, 1), activation="relu", padding="same", name="block1_conv1"),
            Conv2D(
                32,
                (3, 3),
                activation="relu",
            ...
            SpatialDropout2D(rate=dropout_param),
            # Block 3
            Conv2D(128, (3, 3), activation="relu", padding="same", name="block3_conv1"),
            Conv2D(128, (3, 3), activation="relu", padding="same", name="block3_conv2"),
            Conv2D(128, (3, 3), activation="relu", padding="same", name="block3_conv3"),
            ...
            Conv2D(256, (3, 3), activation="relu", padding="same", name="block4_conv3"),
            MaxPooling2D((2, 2), strides=(2, 2), name="block4_pool"),
            # Block 5
            Conv2D(256, (3, 3), activation="relu", padding="same", name="block5_conv1"),
            Conv2D(256, (3, 3), activation="relu", padding="same", name="block5_conv2"),
            ...
            Dense(128, activation="relu", name="fc1"),  # fully connected layers, 128 number of neurons

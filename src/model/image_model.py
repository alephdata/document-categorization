...
import pandas as pd
import mlflow
from sklearn.metrics import confusion_matrix, precision_score, recall_score, accuracy_score, average_precision_score
...
from utils.confusion_matrix import generate_confusion_matrix
import subprocess
from subprocess import CompletedProcess
from config import settings
import numpy as np

from utils.logger import LOGGING_FILENAME
...
class ImageModel:
    ...
    def train_model(self) -> None:
        """Method placeholder. The implementation of this method is done in the sub-classes
            FeatureExtractor, FirstpageClassifier and DocumentClassifier.
        Raises:

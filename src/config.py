...
class Settings(BaseSettings):
    ...
    # JPG files to train the binary firstpage classifier, divided in class folders
    INPUT_IMAGES_FIRSTPAGE_CLASSIFICATION: str = os.path.join(ROOT_PATH, "processed_clean", "firstpage_classifier")  # NOQA E501
    
    MLFLOW_FEATURE_EXTRACTOR_ID = "d28b93d8eb004d1581ca63ad4252a7cf"  # run ID (32er hash), retrievable from MLflow 4b4078d5ccb24ddea6433a954bb23e79  # NOQA E501
    MLFLOW_FIRSTPAGE_CLASSIFICATION_ID = "3f5e4480db2e427792ba197cef570a08"
    ...
    # Path to output trained firstpage classifiers
    OUTPUT_FIRSTPAGE_CLASSIFICATION: str = os.path.join(ROOT_PATH, "output/firstpage_classification/")
    ...
    LABELS_FILTER_FIRSTPAGES: List[str] = [
        "firstpages",
        "middlepages_1233",
    ]
    ...
    PREDICTION_MODELS = {
        ...
        "EfficientNetB4BW": {
            "binary_classifier": os.path.join(ROOT_PATH, "output/firstpage_classification/EfficientNetB4BW_binary_final"),
            "multiclass_classifier": os.path.join(ROOT_PATH, "output/document_classifier/EfficientNetB4BW_multiclass_final")
        },
        "EfficientNetB0": {
            "binary_classifier": os.path.join(ROOT_PATH, "output/firstpage_classification/EfficientNetB0_binary_final"),

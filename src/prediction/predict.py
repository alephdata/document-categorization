...
from preprocessing.convert_to_img import convert_pdf_to_jpg, convert_tif_to_jpg
from preprocessing.train_val_test_split import get_data_files_df

logger = logging.getLogger(__name__)


def load_classifiers(architecture_name: str) -> Tuple[FirstpageClassifier, DocumentClassifier]:
    ...
    Returns:
        Tuple[FirstpageClassifier, DocumentClassifier]: trained classifiers
    """
    binary_classifier = FirstpageClassifier.load_from_path(

...
def firstpage_classifier(tmp_path_session: pathlib.Path) -> FirstpageClassifier:
    firstpage_classifier = FirstpageClassifier(model_name="AlexNet")
...
def test_load_transfer_learning_model_type(firstpage_classifier: FirstpageClassifier) -> None:
    firstpage_classifier.load_transfer_learning_model()
    assert type(firstpage_classifier.model) == Sequential


def test_load_transfer_learning_model_activation_and_loss(firstpage_classifier: FirstpageClassifier) -> None:
    firstpage_classifier.load_transfer_learning_model()
...
def test_load_transfer_learning_model_layers(firstpage_classifier: FirstpageClassifier) -> None:
    firstpage_classifier.load_transfer_learning_model()
